...
/**
 * CustomerJob filter form base class.
 *
 * @package    tts_nam
 * @subpackage filter
 ...
 */
abstract class BaseCustomerJobFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('customer_job_filters[%s]');
