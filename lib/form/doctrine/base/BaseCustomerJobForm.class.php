...
/**
 * CustomerJob form base class.
 *
 * @method CustomerJob getObject() Returns the current form's model object
 *
 * @package    tts_nam
 * @subpackage form
 ...
 */
abstract class BaseCustomerJobForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'CustomerJob', 'column' => array('token')))
    );

    $this->widgetSchema->setNameFormat('customer_job[%s]');
