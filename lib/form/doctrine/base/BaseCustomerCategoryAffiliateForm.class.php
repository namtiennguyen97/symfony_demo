...
/**
 * CustomerCategoryAffiliate form base class.
 *
 * @method CustomerCategoryAffiliate getObject() Returns the current form's model object
 *
 * @package    tts_nam
 * @subpackage form
 ...
 */
abstract class BaseCustomerCategoryAffiliateForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('customer_category_affiliate[%s]');
  ...
  {
    return 'CustomerCategoryAffiliate';
  }
